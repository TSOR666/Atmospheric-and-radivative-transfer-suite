...
- For general conduct concerns: open a confidential issue marked "coc" or contact the maintainers privately via the contact listed in `CITATION.cff` or `README.md`.
- For security or vulnerability concerns: do not open a public issue; follow the process in `SECURITY.md`.
